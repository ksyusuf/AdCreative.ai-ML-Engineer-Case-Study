...
def create_ad_template(generated_image, logo_path, button_punchline_color, punchline, button_text):
    ...
    rounded_rectangle(draw_button, button_position, (button_width, button_height), radius=15, fill=button_punchline_color)
...
image_path = ("C:/Users/ksyus/Documents/Yazılımsal Projeler/adCreative.ai iş başvuru case çalışması/SDV5_OUTPUT/"
              "latte in purple cup.png")
logo_path = "C:/Users/ksyus/Documents/Yazılımsal Projeler/adCreative.ai iş başvuru case çalışması/coffee-logo.png"
punchline = "Kahve dünyasının bir numarası\nSipariş için dokunun"
button_text = "Sipariş   >"
button_punchline_color = "#007bff"  # Örnek renk kodu
SAVE_PATH = "C:/Users/ksyus/Documents/Yazılımsal Projeler/adCreative.ai iş başvuru case çalışması/templateler/kahve"

# Kaynak resmi açın
image = Image.open(image_path)

# Reklam template'ini oluşturun
ad_template = create_ad_template(image, logo_path, button_punchline_color, punchline, button_text)

# Reklam template'ini kaydedin
ad_template.save(uniquify(SAVE_PATH + "_template.png"))
